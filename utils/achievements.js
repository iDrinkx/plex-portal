...
const ACHIEVEMENTS = {
  ...
  temporels: [
    {
      ...
      conditionText: "1 an d'ancienneté sur Minimax TV",
      getProgress: (data) => ({
    ...
    },
    {
      ...
      conditionText: "Plus de 2 ans d'ancienneté sur Minimax TV",
      getProgress: (data) => ({
    ...
    },
    {
      ...
      conditionText: "Plus de 5 ans d'ancienneté sur Minimax TV",
      getProgress: (data) => ({
  ...
  activites: [
    {
      ...
      name: "Premier Pas",
      icon: "🎬",
      description: "Ton premier visionnage sur Minimax TV",
  ...
  secrets: [
    ...
    },
    {
      ...
      name: "Beta Tester",
      icon: "🧪",
      description: "Utilisateur expert Minimax TV en phase beta",
      condition: (data) => false,
      conditionText: "Utilisateur expert Minimax TV en phase beta",
      getProgress: (data) => ({ current: 0, total: 1, percent: 0 }),
      unlockedDate: "31/12/2025",
      category: "secrets",
      isSecret: false
