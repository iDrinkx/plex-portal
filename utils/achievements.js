  ...
  collections: [
    {
      ...
      name: "Marvel Fan",
      icon: "🦸",
      description: "A regardé les films et séries de la collection Marvel disponibles sur le serveur",
      condition: (data) => false,
      conditionText: "A regardé les films et séries de la collection Marvel disponibles sur le serveur",
    ...
    },
    {
      ...
      name: "Maître Jedi",
      icon: "🧑‍⚖️",
      description: "A regardé toute la collection Star Wars disponible sur le serveur",
      condition: (data) => false,
      conditionText: "A regardé toute la collection Star Wars disponible sur le serveur",
      getProgress: () => getDynamicCollectionProgress(),
      unlockedDate: null,
      category: "collections",
      isSecret: false,
    ...
    },
    {
      ...
      icon: "🦕",
      description: "A survécu à toute la collection Jurassic disponible sur le serveur",
      condition: (data) => false,
      conditionText: "A survécu à toute la collection Jurassic disponible sur le serveur",
      getProgress: () => getDynamicCollectionProgress(),
      unlockedDate: null,
      category: "collections",
      isSecret: false,
    ...
    },
    {
      ...
      icon: "⚡",
      description: "A regardé toute la collection Wizarding World disponible sur le serveur",
      condition: (data) => false,
      conditionText: "A regardé toute la collection Wizarding World disponible sur le serveur",
      getProgress: () => getDynamicCollectionProgress(),
      unlockedDate: null,
      category: "collections",
      isSecret: false,
    ...
    },
    {
      ...
      name: "Middle Earth",
      icon: "👑",
      description: "A regardé toute la collection Middle Earth disponible sur le serveur",
      condition: (data) => false,
      conditionText: "A regardé toute la collection Middle Earth disponible sur le serveur",
      getProgress: () => getDynamicCollectionProgress(),
      unlockedDate: null,
      category: "collections",
      isSecret: false,
    ...
    },
    {
      ...
      name: "Évolutionniste",
      icon: "🐵",
      description: "A regardé toute la collection La Planète des Singes disponible sur le serveur",
      condition: (data) => false,
      conditionText: "A regardé toute la collection La Planète des Singes disponible sur le serveur",
      getProgress: () => getDynamicCollectionProgress(),
      unlockedDate: null,
      category: "collections",
      isSecret: false,
    ...
    },
    {
      ...
      name: "MonsterVerse",
      icon: "🦖",
      description: "A regardé toute la collection MonsterVerse disponible sur le serveur",
      condition: (data) => false,
      conditionText: "A regardé toute la collection MonsterVerse disponible sur le serveur",
    ...
    },
    {
      ...
      name: "Agent 007",
      icon: "🕴️",
      description: "A regardé toute la collection James Bond 007 disponible sur le serveur",
      condition: (data) => false,
      conditionText: "A regardé toute la collection James Bond 007 disponible sur le serveur",
      getProgress: () => getDynamicCollectionProgress(),
      unlockedDate: null,
      category: "collections",
      isSecret: false,
    ...
    },
    {
      ...
      name: "Fast Family",
      icon: "🏎️",
      description: "A regardé toute la collection Fast and Furious disponible sur le serveur",
      condition: (data) => false,
      conditionText: "A regardé toute la collection Fast and Furious disponible sur le serveur",
      getProgress: () => getDynamicCollectionProgress(),
      unlockedDate: null,
      category: "collections",
      isSecret: false,
    ...
    },
    {
      ...
      icon: "🖖",
      description: "A regardé les films et séries de la collection Star Trek disponibles sur le serveur",
      condition: (data) => false,
      conditionText: "A regardé les films et séries de la collection Star Trek disponibles sur le serveur",
      getProgress: () => getDynamicCollectionProgress(),
      unlockedDate: null,
      category: "collections",
      isSecret: false,
    ...
    },
    {
      ...
      name: "Arrowverse",
      icon: "🏹",
      description: "A regardé toute la collection Arrowverse disponible sur le serveur",
      condition: (data) => false,
      conditionText: "A regardé toute la collection Arrowverse disponible sur le serveur",
      getProgress: () => getDynamicCollectionProgress(),
      unlockedDate: null,
      category: "collections",
      isSecret: false,
